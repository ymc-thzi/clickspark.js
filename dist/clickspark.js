 ...
 */
 (function(){
    ...
    $.fn.clickSpark = function (spec) {
        var spec = $.extend({}, csDefaultSpecs, spec);
    ...
    var clickSpark = function (spec) {
        ...
        var $document, $body, $canvasContainer, $particleCanvas;
        /*
         * prepareDOMElements
         */
        function prepareDOMElements() {
            ...
            $document.ready(function () {
                ...
                $canvasContainer = $('.cs-canvas-container');
                $particleCanvas = $('#cs-particle-canvas');
        ...
        function fireParticles(e) {
            ...
            $body.css({
                'overflow-y': ($document.height() > $window.height())? 'inherit' : 'hidden',
                'overflow-x': ($document.width() > $window.width())? 'inherit' : 'hidden'
            });
            ...
            window.setTimeout(function () {
                $particleCanvas.fadeOut(fadeCompleted);
            }, particleDuration);
            running = true;
            animate();
